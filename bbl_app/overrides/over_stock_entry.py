...
mock_bar_to_forge =  {'name': 'MAT-STE-2024-00292', 'owner': 'Administrator', 'creation': '2024-07-10 09:57:49', 'modified': '2024-07-10 09:58:02', 'modified_by': 'Administrator', 'docstatus': 1, 'idx': 0, 'naming_series': 'MAT-STE-.YYYY.-', 'stock_entry_type': 'Manufacture', 'outgoing_stock_entry': None, 'purpose': 'Manufacture', 'add_to_transit': 0, 'work_order': 'MFG-WO-2024-00031', 'purchase_order': None, 'subcontracting_order': None, 'delivery_note_no': None, 'sales_invoice_no': None, 'pick_list': None, 'purchase_receipt_no': None, 'company': '百兰车轴', 'posting_date': '2024-07-10', 'posting_time': '09:58:02.213025', 'set_posting_time': 0, 'inspection_required': 0, 'apply_putaway_rule': 0, 'from_bom': 1, 'use_multi_level_bom': 1, 'bom_no': 'BOM-30BC_锻坯-001', 'fg_completed_qty': 160.0, 'process_loss_percentage': 0.0, 'process_loss_qty': 0.0, 'from_warehouse': '锻造车间仓库 - 百兰', 'source_warehouse_address': None, 'source_address_display': None, 'to_warehouse': '锻造车间仓库 - 百兰', 'target_warehouse_address': None, 'target_address_display': None, 'scan_barcode': None, 'total_outgoing_value': 29948.8, 'total_incoming_value': 29948.8, 'value_difference': 0.0, 'total_additional_costs': 0.0, 'supplier': None, 'supplier_name': None, 'supplier_address': None, 'address_display': None, 'project': None, 'select_print_heading': None, 'letter_head': None, 'is_opening': 'No', 'remarks': None, 'per_transferred': 0.0, 'total_amount': 0.0, 'job_card': None, 'amended_from': None, 'credit_note': None, 'is_return': 0, 'doctype': 'Stock Entry', 'items': [{'name': 'mahb0ibhb8', 'owner': 'Administrator', 'creation': '2024-07-10 09:57:49', 'modified': '2024-07-10 09:58:02', 'modified_by': 'Administrator', 'docstatus': 1, 'idx': 1, 'barcode': None, 'has_item_scanned': 0, 's_warehouse': '锻造车间仓库 - 百兰', 't_warehouse': None, 'item_code': '30BC_短棒料', 'item_name': '30BC_短棒料', 'is_finished_item': 0, 'is_scrap_item': 0, 'quality_inspection': None, 'subcontracted_item': None, 'description': '30BC_短棒料', 'item_group': '短棒料', 'image': None, 'qty': 160.0, 'transfer_qty': 160.0, 'retain_sample': 0, 'uom': '根', 'stock_uom': '根', 'conversion_factor': 1.0, 'sample_quantity': 0, 'basic_rate': 187.18, 'additional_cost': 0.0, 'valuation_rate': 187.18, 'allow_zero_valuation_rate': 0, 'set_basic_rate_manually': 0, 'basic_amount': 29948.8, 'amount': 29948.8, 'use_serial_batch_fields': 0, 'serial_and_batch_bundle': 'SABB-00000923', 'serial_no': None, 'batch_no': None, 'expense_account': '库存调整 - 百兰', 'cost_center': '主 - 百兰', 'project': None, 'actual_qty': 160.0, 'transferred_qty': 0.0, 'bom_no': None, 'allow_alternative_item': 0, 'material_request': None, 'material_request_item': None, 'original_item': None, 'against_stock_entry': None, 'ste_detail': None, 'po_detail': None, 'sco_rm_detail': None, 'putaway_rule': None, 'reference_purchase_receipt': None, 'job_card_item': None, 'parent': 'MAT-STE-2024-00292', 'parentfield': 'items', 'parenttype': 'Stock Entry', 'doctype': 'Stock Entry Detail', '__unsaved': 1}, {'name': 'mahbhi855m', 'owner': 'Administrator', 'creation': '2024-07-10 09:57:49', 'modified': '2024-07-10 09:58:02', 'modified_by': 'Administrator', 'docstatus': 1, 'idx': 2, 'barcode': None, 'has_item_scanned': 0, 's_warehouse': None, 't_warehouse': '锻造车间仓库 - 百兰', 'item_code': '30BC_锻坯', 'item_name': '30BC_锻坯', 'is_finished_item': 1, 'is_scrap_item': 0, 'quality_inspection': None, 'subcontracted_item': None, 'description': '30BC_锻坯', 'item_group': '过程半成品', 'image': None, 'qty': 160.0, 'transfer_qty': 160.0, 'retain_sample': 0, 'uom': '根', 'stock_uom': '根', 'conversion_factor': 1.0, 'sample_quantity': 0, 'basic_rate': 187.18, 'additional_cost': 0.0, 'valuation_rate': 187.18, 'allow_zero_valuation_rate': 0, 'set_basic_rate_manually': 0, 'basic_amount': 29948.8, 'amount': 29948.8, 'use_serial_batch_fields': 0, 'serial_and_batch_bundle': None, 'serial_no': None, 'batch_no': None, 'expense_account': '库存调整 - 百兰', 'cost_center': '主 - 百兰', 'project': None, 'actual_qty': 0.0, 'transferred_qty': 0.0, 'bom_no': 'BOM-30BC_锻坯-001', 'allow_alternative_item': 0, 'material_request': None, 'material_request_item': None, 'original_item': None, 'against_stock_entry': None, 'ste_detail': None, 'po_detail': None, 'sco_rm_detail': None, 'putaway_rule': None, 'reference_purchase_receipt': None, 'job_card_item': None, 'parent': 'MAT-STE-2024-00292', 'parentfield': 'items', 'parenttype': 'Stock Entry', 'doctype': 'Stock Entry Detail', '__unsaved': 1}], 'additional_costs': []}
...
def process_bar_to_forge(self):
    ...
    for item in item_docs:
        if '短棒料' in item.get('item_code'):
            ...
            print_green('处理锻坯')
            create_forge_blank(bar_item, item)

def adjust_short_bar_status(sabb_no):
    ...
    for batch in batchs:
        ...
        wip_piece = srb_doc.wip_piece - abs(batch.qty)
        if wip_piece == 0:
            srb_doc.status = "在制品用完"
...
def create_forge_blank(bar_item, forge_item):
    print_blue("新建锻坯信息")
    ...
    adjust_short_bar_status(sabb_no)
    sabb_doc = frappe.get_cached_doc('Serial and Batch Bundle', sabb_no)
    ...
    forge_doc.insert(ignore_links=True)
